...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim training and technique improvement sessions",
    ...
    # Intellectual
    "Math Olympiad": {
        "description": "Preparation for competitive mathematics contests",
        "schedule": "Mondays, 3:30 PM - 4:30 PM",
        "max_participants": 16,
        "participants": ["ethan@mergington.edu", "isabella@mergington.edu"]
    },
    "Debate Team": {
        "description": "Research, argument development, and debate tournaments",
